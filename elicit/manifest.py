"""Write provenance metadata for the post-dissertation elicitation experiment."""
from __future__ import annotations

from paths import ELICIT_MANIFEST


TEXT = """# Elicitation experiment manifest
...
def write_manifest() -> None:
    ELICIT_MANIFEST.parent.mkdir(parents=True, exist_ok=True)
    ELICIT_MANIFEST.write_text(TEXT)


if __name__ == "__main__":
    write_manifest()
    print(f"wrote {ELICIT_MANIFEST}")
