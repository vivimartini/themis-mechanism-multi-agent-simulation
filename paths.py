...
ELICIT_HAND_CHECK = REFERENCE / "elicitation_hand_check.md"
ELICIT_JOINT_JSON = DATA / "elicitation_joint_enumeration.json"
ELICIT_DIFFERENTIAL = REFERENCE / "elicitation_differential_check.md"
ELICIT_ROBUSTNESS_NPZ = DATA / "elicitation_robustness.npz"
ELICIT_ROBUSTNESS_PDF = FIGURES / "fig_elicitation_robustness.pdf"
ELICIT_ROBUSTNESS_PNG = FIGURES / "fig_elicitation_robustness.png"
ELICIT_RULE_TABLE = REFERENCE / "elicitation_rule_comparison.md"
